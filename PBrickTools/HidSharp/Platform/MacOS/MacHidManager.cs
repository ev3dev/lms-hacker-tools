...
namespace HidSharp.Platform.MacOS
{
    class MacHidManager : HidManager
    {
        ...
        {
            creationState = null;
            var path = (NativeMethods.io_string_t)key;
            var hidDevice = new MacHidDevice (path);
        ...
        public override bool IsSupported {
            get {
                try {
                    IntPtr major;
                    NativeMethods.OSErr majorErr = NativeMethods.Gestalt (NativeMethods.OSType.gestaltSystemVersionMajor, out major);
                    IntPtr minor;
                    NativeMethods.OSErr minorErr = NativeMethods.Gestalt (NativeMethods.OSType.gestaltSystemVersionMinor, out minor);
